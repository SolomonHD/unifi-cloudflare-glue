# Specification: KCL UniFi Generator
...
1. Use KCL comprehensions for list transformations
2. Leverage the existing `normalize_mac()` function from `base.k`
3. Use KCL's automatic null/undefined omission for optional fields
4. The generator should be a pure function with no side effects
